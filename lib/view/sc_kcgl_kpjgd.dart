...
class sc_kcgl_kpjgd extends StatelessWidget {
  sc_kcgl_kpjgd({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            Stack(
              children: <Widget>[
                ...
                Transform.translate(
                  offset: Offset(954.97, 724.48),
                  child: SpecificRectClip(
                    rect: Rect.fromLTWH(0, 0, 742, 92),
                    child: UnconstrainedBox(
                      alignment: Alignment.topLeft,
                      child: Container(
                        width: 764,
                        ...
                        child: GridView.count(
                          ...
                          children: [
                            ...
                            final text = map['text'];
                            return Transform.translate(
                              offset: Offset(-954.97, -741.48),
                              child: Stack(
                                children: <Widget>[
                                  Transform.translate(
                                    offset: Offset(-0.03, -5.52),
                                    child:
                                    // layer: 'row' (group)
                                    Stack(
                                      children: <Widget>[
