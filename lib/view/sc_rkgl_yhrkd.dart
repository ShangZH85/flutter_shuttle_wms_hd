...
class sc_rkgl_yhrkd extends StatelessWidget {
  sc_rkgl_yhrkd({
    Key key,
  }) : super(key: key);
                    ...
                    Stack(
                      children: <Widget>[
                        ...
                        Transform.translate(
                            ...
                            child: Icon(Icons.pie_chart, color: Colors.white30)
