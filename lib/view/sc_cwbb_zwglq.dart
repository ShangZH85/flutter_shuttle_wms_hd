...
class sc_cwbb_zwglq extends StatelessWidget {
  sc_cwbb_zwglq({
    Key key,
  }) : super(key: key);
  @override
                    ...
                    Stack(
                      children: <Widget>[
                        ...
                        Transform.translate(
                            ...
                            child:
                            Icon(Icons.pie_chart,color:const Color(0xffa3a0fb))
                ...
                Transform.translate(
                  ...
                  Stack(
                    children: <Widget>[
                      ...
                      Transform.translate(
                        offset: Offset(260.0, 14.0),
                        child: Text(
                          '科目                           客户名称                   部门                   费用发生额                    实际应收                     还款' ,
                          style: TextStyle(
                            fontFamily: 'Source Sans Pro',
                            fontSize: 13,
                            color: const Color(0xffa3a6b4),
