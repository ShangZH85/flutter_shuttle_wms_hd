...
class sc_xtsz_fyfsgl extends StatelessWidget {
  sc_xtsz_fyfsgl({
    Key key,
  }) : super(key: key);
  @override
                    ...
                    child: UnconstrainedBox(
                      ...
                      Container(
                        ...
                        child: GridView.count(
                          ...
                          children: [
                            {
                              'name': Icon(Icons.check_box_outline_blank,color: Colors.blue,),
                              'specifications': '结算中心现收款账户',
                              'model': '-',
                              'origin': '2020-01-01',
                              'text1':'现手入库费',
                              'weight': '166',
