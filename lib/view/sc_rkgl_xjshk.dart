...
class sc_rkgl_xjshk extends StatelessWidget {
  sc_rkgl_xjshk({
    Key key,
  }) : super(key: key);
  @override
                    ...
                    Stack(
                      children: <Widget>[
                        ...
                        Transform.translate(
                            ...
                            child:Icon(Icons.assessment,color: const Color(0xffa3a0fb),)
          ...
          Transform.translate(
            ...
            Stack(
              children: <Widget>[
                ...
                Transform.translate(
                  offset: Offset(1506.0, 989.33),
                  child:
                  // layer: 'Show More Link' (text)
                  SizedBox(
                    width: 77.0,
                    child: Text(
                      'Show More',
                ...
                Transform.translate(
                  ...
                  // layer: 'row' (none)
                  SpecificRectClip(
                    rect: Rect.fromLTWH(0, 0, 1200, 48),
